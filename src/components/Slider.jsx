...
function FullscreenModal(props) {
  ...
  return (
    <AnimatePresence initial={true}>
      {toggleModal && (
        <motion.div
          className="fixed top-0 bottom-0 flex flex-col justify-start items-center w-full h-full max-h-[100%] bg-neutral-950/90 z-50 overflow-y-scroll overscroll-contain"
          data-lenis-prevent
